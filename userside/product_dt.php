                ...
                <div id="rev_card" class="card">
                    <div class="row">
                        ...
                        while ($itemreview = $stmt->fetch()) {
                            echo "<i style='float: left; margin-top: -8px; margin-right: 5px; font-size: 40px;' class='fa fa-user'></i>" . " " . "<b>" .$itemreview["Username"]. "</b>" . " gave a rating of " . "<b>" .$itemreview["Rating"]. " out of 5 stars</b>";
