...
<body>
    <div class="accountbody">
                ...
                foreach ($order_stmt as $order) {
                    ...
                    <div class='review'>
                        <form method ='post' id="<?php echo $orderid."-".$itemid; ?>" class='reviewform' action='reviewitem.php'>
                            <h4>Rating</h4>
                            <span onclick="star(1)" class="fa fa-star" value="1"></span>
                            <span onclick="star(2)" class="fa fa-star" value="2"></span>
                            <span onclick="star(3)" class="fa fa-star" value="3"></span>
                            <span onclick="star(4)" class="fa fa-star" value="4"></span>
                            <span onclick="star(5)" class="fa fa-star" value="5"></span><br>
            ...
            <script>
                ...
                let output = document.getElementById("stars");
